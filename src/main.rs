...
fn cornell_smoke() -> io::Result<()> {
    ...
    world.add(Rc::new(ConstantMedium::from_color(box_1, 0.01, Color::new(0.0, 0.0, 0.0))));
    ...
    world.add(Rc::new(ConstantMedium::from_color(box_2, 0.01, Color::new(1.0, 1.0, 1.0))));
